...
cuda-torch-notebook
===================
Ubuntu Core 14.04 + [CUDA 8.0](http://www.nvidia.com/object/cuda_home_new.html) + [cuDNN v5](https://developer.nvidia.com/cuDNN) + [Torch7](http://torch.ch/) (including iTorch).
...
Usage
-----
Use NVIDIA Docker: ``grez2/cuda-torch-notebook``.
